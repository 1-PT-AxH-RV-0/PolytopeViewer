  ...
  polyhedra: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: '筝形二十四面体', path: 'Catalan/Deltoidal_icositetrahedron.off' },
        { name: '五角二十四面体', path: 'Catalan/Pentagonal_icositetrahedron.off' },
        { name: '四角化菱形十二面体', path: 'Catalan/Disdyakis_dodecahedron.off' },
        ...
        { name: '五角六十面体', path: 'Catalan/Pentagonal_hexecontahedron.off' },
        { name: '四角化菱形三十面体', path: 'Catalan/Disdyakis_triacontahedron.off' }
      ]
    },
    {
      id: 'johnson',
      ...
      items: [
        ...
        { name: '正三角锥柱', path: 'Johnson/Elongated_triangular_pyramid.off' },
        { name: '正四角锥柱', path: 'Johnson/Elongated_square_pyramid.off' },
        { name: '正五角锥柱', path: 'Johnson/Elongated_pentagonal_pyramid.off' },
        { name: '四角锥反角柱', path: 'Johnson/Gyroelongated_square_pyramid.off' },
        { name: '五角锥反角柱', path: 'Johnson/Gyroelongated_pentagonal_pyramid.off' },
        { name: '双三角锥', path: 'Johnson/Triangular_bipyramid.off' },
        { name: '双五角锥', path: 'Johnson/Pentagonal_bipyramid.off' },
        { name: '双三角锥柱', path: 'Johnson/Elongated_triangular_bipyramid.off' },
        { name: '双四角锥柱', path: 'Johnson/Elongated_square_bipyramid.off' },
        { name: '双五角锥柱', path: 'Johnson/Elongated_pentagonal_bipyramid.off' },
        { name: '双四角锥反角柱', path: 'Johnson/Gyroelongated_square_bipyramid.off' },
        ...
        { name: '正五角丸塔柱', path: 'Johnson/Elongated_pentagonal_rotunda.off' },
        { name: '正三角台塔反角柱', path: 'Johnson/Gyroelongated_triangular_cupola.off' },
        { name: '正四角台塔反角柱', path: 'Johnson/Gyroelongated_square_cupola.off' },
        { name: '正五角台塔反角柱', path: 'Johnson/Gyroelongated_pentagonal_cupola.off' },
        { name: '正五角丸塔反角柱', path: 'Johnson/Gyroelongated_pentagonal_rotunda.off' },
        { name: '异相双三角柱', path: 'Johnson/Gyrobifastigium.off' },
        { name: '同相双三角台塔', path: 'Johnson/Triangular_orthobicupola.off' },
        { name: '同相双四角台塔', path: 'Johnson/Square_orthobicupola.off' },
        { name: '异相双四角台塔', path: 'Johnson/Square_gyrobicupola.off' },
        { name: '同相双五角台塔', path: 'Johnson/Pentagonal_orthobicupola.off' },
        { name: '异相双五角台塔', path: 'Johnson/Pentagonal_gyrobicupola.off' },
        { name: '同相五角台塔丸塔', path: 'Johnson/Pentagonal_orthocupolarotunda.off' },
        { name: '异相五角台塔丸塔', path: 'Johnson/Pentagonal_gyrocupolarotunda.off' },
        { name: '同相双五角丸塔', path: 'Johnson/Pentagonal_orthobirotunda.off' },
        { name: '同相双三角台塔柱', path: 'Johnson/Elongated_triangular_orthobicupola.off' },
        { name: '异相双三角台塔柱', path: 'Johnson/Elongated_triangular_gyrobicupola.off' },
        { name: '异相双四角台塔柱', path: 'Johnson/Elongated_square_gyrobicupola.off' },
        { name: '同相双五角台塔柱', path: 'Johnson/Elongated_pentagonal_orthobicupola.off' },
        { name: '异相双五角台塔柱', path: 'Johnson/Elongated_pentagonal_gyrobicupola.off' },
        { name: '同相五角台塔丸塔柱', path: 'Johnson/Elongated_pentagonal_orthocupolarotunda.off' },
        { name: '异相五角台塔丸塔柱', path: 'Johnson/Elongated_pentagonal_gyrocupolarotunda.off' },
        { name: '同相五角双丸塔柱', path: 'Johnson/Elongated_pentagonal_orthobirotunda.off' },
        { name: '异相五角双丸塔柱', path: 'Johnson/Elongated_pentagonal_gyrobirotunda.off' },
        { name: '双三角台塔反角柱', path: 'Johnson/Gyroelongated_triangular_bicupola.off' },
        { name: '双四角台塔反角柱', path: 'Johnson/Gyroelongated_square_bicupola.off' },
        { name: '双五角台塔反角柱', path: 'Johnson/Gyroelongated_pentagonal_bicupola.off' },
        { name: '五角台塔丸塔反角柱', path: 'Johnson/Gyroelongated_pentagonal_cupolarotunda.off' },
        { name: '双五角丸塔反角柱', path: 'Johnson/Gyroelongated_pentagonal_birotunda.off' },
        { name: '侧锥三角柱', path: 'Johnson/Augmented_triangular_prism.off' },
        { name: '二侧锥三角柱', path: 'Johnson/Biaugmented_triangular_prism.off' },
        { name: '三侧锥三角柱', path: 'Johnson/Triaugmented_triangular_prism.off' },
        { name: '侧锥五角柱', path: 'Johnson/Augmented_pentagonal_prism.off' },
        { name: '间二侧锥五角柱', path: 'Johnson/Biaugmented_pentagonal_prism.off' },
        { name: '侧锥六角柱', path: 'Johnson/Augmented_hexagonal_prism.off' },
        { name: '对二侧锥六角柱', path: 'Johnson/Parabiaugmented_hexagonal_prism.off' },
        { name: '间二侧锥六角柱', path: 'Johnson/Metabiaugmented_hexagonal_prism.off' },
        { name: '三侧锥六角柱', path: 'Johnson/Triaugmented_hexagonal_prism.off' },
        { name: '侧锥正十二面体', path: 'Johnson/Augmented_dodecahedron.off' },
        { name: '对二侧锥正十二面体', path: 'Johnson/Parabiaugmented_dodecahedron.off' },
        { name: '间二侧锥正十二面体', path: 'Johnson/Metabiaugmented_dodecahedron.off' },
        { name: '三侧锥正十二面体', path: 'Johnson/Triaugmented_dodecahedron.off' },
        { name: '正二十面体欠邻二侧锥', path: 'Johnson/Metabidiminished_icosahedron.off' },
        { name: '正二十面体欠三侧锥', path: 'Johnson/Tridiminished_icosahedron.off' },
        { name: '侧锥正二十面体欠三侧锥', path: 'Johnson/Augmented_tridiminished_icosahedron.off' },
        { name: '侧台塔截角四面体', path: 'Johnson/Augmented_truncated_tetrahedron.off' },
        { name: '侧台塔截角立方体', path: 'Johnson/Augmented_truncated_cube.off' },
        { name: '对二侧台塔截角立方体', path: 'Johnson/Biaugmented_truncated_cube.off' },
        { name: '侧台塔截角十二面体', path: 'Johnson/Augmented_truncated_dodecahedron.off' },
        { name: '对二侧台塔截角十二面体', path: 'Johnson/Parabiaugmented_truncated_dodecahedron.off' },
        { name: '间二侧台塔截角十二面体', path: 'Johnson/Metabiaugmented_truncated_dodecahedron.off' },
        { name: '三侧台塔截角十二面体', path: 'Johnson/Triaugmented_truncated_dodecahedron.off' },
        { name: '单旋侧台塔小斜方截半二十面体', path: 'Johnson/Gyrate_rhombicosidodecahedron.off' },
        { name: '对二旋侧台塔小斜方截半二十面体', path: 'Johnson/Parabigyrate_rhombicosidodecahedron.off' },
        { name: '邻二旋侧台塔小斜方截半二十面体', path: 'Johnson/Metabigyrate_rhombicosidodecahedron.off' },
        { name: '三旋侧台塔小斜方截半二十面体', path: 'Johnson/Trigyrate_rhombicosidodecahedron.off' },
        { name: '小斜方截半二十面体欠一侧台塔', path: 'Johnson/Diminished_rhombicosidodecahedron.off' },
        { name: '对单旋侧台塔小斜方截半二十面体欠一侧台塔', path: 'Johnson/Paragyrate_diminished_rhombicosidodecahedron.off' },
        { name: '邻单旋侧台塔小斜方截半二十面体欠一侧台塔', path: 'Johnson/Metagyrate_diminished_rhombicosidodecahedron.off' },
        { name: '二旋侧台塔小斜方截半二十面体欠一侧台塔', path: 'Johnson/Bigyrate_diminished_rhombicosidodecahedron.off' },
        { name: '小斜方截半二十面体欠对二侧台塔', path: 'Johnson/Parabidiminished_rhombicosidodecahedron.off' },
        { name: '小斜方截半二十面体欠邻二侧台塔', path: 'Johnson/Metabidiminished_rhombicosidodecahedron.off' },
        { name: '单旋侧台塔小斜方截半二十面体欠二侧台塔', path: 'Johnson/Gyrate_bidiminished_rhombicosidodecahedron.off' },
        { name: '小斜方截半二十面体欠三侧台塔', path: 'Johnson/Tridiminished_rhombicosidodecahedron.off' },
        ...
        { name: '广底加长型球状屋顶', path: 'Johnson/Hebesphenomegacorona.off' },
        { name: '五角锥球状屋顶', path: 'Johnson/Disphenocingulum.off' },
        { name: '双新月双丸塔', path: 'Johnson/Bilunabirotunda.off' },
        { name: '三角广底球状丸塔', path: 'Johnson/Triangular_hebesphenorotunda.off' }
      ]
    },
    {
      id: 'special',
    ...
    },
    {
      ...
      label: '皮特里柏拉图多面体',
      items: [
        { name: '皮特里四面体', path: 'Petrial/Platonic/Petrial_tetrahedron.off' },
        { name: '皮特里立方体', path: 'Petrial/Platonic/Petrial_cube.off' },
        { name: '皮特里八面体', path: 'Petrial/Platonic/Petrial_octahedron.off' },
        { name: '皮特里十二面体', path: 'Petrial/Platonic/Petrial_dodecahedron.off' },
        { name: '皮特里二十面体', path: 'Petrial/Platonic/Petrial_icosahedron.off' }
      ]
    },
    {
      ...
      label: '皮特里开普勒——普安索多面体',
      items: [
        { name: '皮特里大二十面体', path: 'Petrial/KeplerPoinsot/Petrial_great_icosahedron.off' },
        { name: '皮特里大十二面体', path: 'Petrial/KeplerPoinsot/Petrial_great_dodecahedron.off' },
        { name: '皮特里大星形十二面体', path: 'Petrial/KeplerPoinsot/Petrial_great_stellated_dodecahedron.off' },
        { name: '皮特里小星形十二面体', path: 'Petrial/KeplerPoinsot/Petrial_small_stellated_dodecahedron.off' }
      ]
    },
    {
      id: 'petrialTiling',
      label: '皮特里正密铺',
      items: [
        { name: '皮特里三角形密铺', path: 'Petrial/Tiling/Petrial_triangular_tiling.off' },
        { name: '皮特里正方形密铺', path: 'Petrial/Tiling/Petrial_square_tiling.off' },
        { name: '皮特里六边形密铺', path: 'Petrial/Tiling/Petrial_hexgonal_tiling.off' }
      ]
    },
    {
      id: 'uniformCompounds',
      ...
      items: [
        ...
        { name: '五复合四面半六面体/半斜方手性二十面体', path: 'Comp/5Thah.off' },
        { name: '二十复合四面半六面体/扭棱准扭棱斜方二十面体', path: 'Comp/20Thah.off' },
        { name: '六复合五角反角柱/大扭棱十二面体', path: 'Comp/6Pap.off' },
        { name: '十二复合五角反角柱/大双扭棱十二面体', path: 'Comp/12Pap.off' },
        { name: '六复合五角星交错反角柱/大逆扭棱十二面体', path: 'Comp/6Starp.off' },
        { name: '十二复合五角星交错反角柱/大逆双扭棱十二面体', path: 'Comp/12Starp.off' }
      ]
    }
  ],
  ...
  polychora: [
    {
      ...
      items: [
        ...
        { name: '正一百二十胞体', path: 'RegularConvex/Hecatonicosachoron.off' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: '截角巨大一百二十胞体', path: 'TruncatedSchläfliHess/Tigaghi.off' },
        { name: '截角刻面六百胞体', path: 'TruncatedSchläfliHess/Tiffix.off' },
        { name: '截角大刻面六百胞体', path: 'TruncatedSchläfliHess/Tigfix.off' },
    ...
    },
    {
      ...
      label: '截半凸正多胞体',
      items: [
        { name: '截半五胞体', path: 'RectifiedRegularConvex/Rectified_pentachoron.off' },
        { name: '截半超立方体', path: 'RectifiedRegularConvex/Rectified_tesseract.off' },
        { name: '截半二十四胞体', path: 'RectifiedRegularConvex/Rectified_icositetrachoron.off' },
        { name: '截半一百二十胞体', path: 'RectifiedRegularConvex/Rectified_hecatonicosachoron.off' },
        { name: '截半六百胞体', path: 'RectifiedRegularConvex/Rectified_hexacosichoron.off' }
      ]
    },
    {
      ...
      items: [
        ...
        { name: '截半巨大一百二十胞体', path: 'RectifiedSchläfliHess/Ragaghi.off' },
        { name: '截半小星形一百二十胞体', path: 'RectifiedSchläfliHess/Rasishi.off' },
        { name: '截半大星形一百二十胞体', path: 'RectifiedSchläfliHess/Ragishi.off' },
        { name: '截半巨星形一百二十胞体', path: 'RectifiedSchläfliHess/Ragashi.off' },
        { name: '截半巨大星形一百二十胞体', path: 'RectifiedSchläfliHess/Rigogishi.off' },
        { name: '截半刻面六百胞体', path: 'RectifiedSchläfliHess/Rofix.off' },
        { name: '截半大刻面六百胞体', path: 'RectifiedSchläfliHess/Rigfix.off' },
