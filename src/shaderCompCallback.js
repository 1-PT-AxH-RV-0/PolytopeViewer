...
function axisMaterial(material, rotUni, projDistUni, axesRealLenUni) {
  material = material.clone();
...
export default { sphereMaterial, cylinderMaterial, faceMaterial, axisMaterial, axisConeMaterial, axisLabelMaterial }